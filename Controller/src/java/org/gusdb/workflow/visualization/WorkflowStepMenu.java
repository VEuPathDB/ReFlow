...
public class WorkflowStepMenu extends JPopupMenu {
  ...
  public static class WorkflowStepDetailsItem extends JMenuItem implements
      VertexMenuListener<WorkflowStep>, MenuPointListener {
    
    private static final long serialVersionUID = 1L;
    
    WorkflowStep step;
    VisualizationViewer<WorkflowStep, ?> visComp;
    Point2D point;

    public void setVertexAndView(WorkflowStep step,
        VisualizationViewer<WorkflowStep, ?> visComp) {
      this.step = step;
    ...
    public WorkflowStepDetailsItem(final JFrame frame) {
      ...
      this.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          WorkflowStepPropertyDialog dialog = new WorkflowStepPropertyDialog(
              frame, step);
