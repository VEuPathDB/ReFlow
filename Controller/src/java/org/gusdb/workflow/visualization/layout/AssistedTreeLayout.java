package org.gusdb.workflow.visualization.layout;
...
public class AssistedTreeLayout<V extends Comparable<? super V>, E extends Comparable<? super E>> implements Layout<V, E> {

  protected Dimension size = new Dimension(600, 600);
  protected DirectedGraph<V, E> graph;
  protected Forest<V, E> tree;
   ...
   */
  public AssistedTreeLayout(DirectedGraph<V, E> g) {
   ...
   * distance.
   */
  public AssistedTreeLayout(DirectedGraph<V, E> g, int distx) {
   ...
   */
  public AssistedTreeLayout(DirectedGraph<V, E> g, int distx, int disty) {
    if (g == null)
    ...
    this.distX = distx;
    this.distY = disty;
    initializeHelperTree();
    buildTree();
  }

  protected void initializeHelperTree() {
  ...
  private static <T extends Comparable<? super T>> Collection<T> sortCollection(Collection<T> items) {
